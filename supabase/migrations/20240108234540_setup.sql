...
AS $$
DECLARE
  project_url TEXT := current_setting('env.NEXT_PUBLIC_SUPABASE_URL');
  service_role_key TEXT := current_setting('env.SUPABASE_SERVICE_ROLE_KEY'); -- full access needed for http request to storage
